...
export const Login = () => {
  ...
  // Get destination route from navigation state
  ...
  const handleSubmit = async (e) => {
    ...
    if (!email || !password) {
      setValidationErr('Please fill in all security fields.');
      return;
    }
      ...
      <div className="max-w-md w-full space-y-8 glass-panel p-8 rounded-2xl border border-white/5 relative overflow-hidden">
        ...
        <div>
          ...
          <p className="mt-2 text-center text-sm text-slate-400">
            Secure administrative entrance to FalconSpido.
          </p>
        </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="admin@falconspido.com"
